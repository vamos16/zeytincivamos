...
Logo eklidir: `assets/img/koklu-logo.png`
...
Bu final pakette sadece publishable key `assets/js/config.js` içine yazıldı.
...
- `assets/js/config.js` içine Project URL ve anon key yazıldı mı?
